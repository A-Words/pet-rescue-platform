...
class AdoptionApplication(Base):
    ...
    __table_args__ = (UniqueConstraint("adoptable_pet_id", "applicant_id", name="uq_adoptable_pet_applicant"),)
    ...
    applicant_id = Column(UUID(as_uuid=True), ForeignKey("users.user_id"), nullable=False)
