...
class FoundClue(Base):
    ...
    found_clue_id = Column(UUID(as_uuid=True), primary_key=True, default=uuid4)
    lost_pet_id = Column(UUID(as_uuid=True), ForeignKey("lost_pets.lost_pet_id"), nullable=False)
